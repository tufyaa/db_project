...
```
cd existing_repo
git remote add origin https://gitlab.atp-fivt.org/tsvetkoveg/project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.atp-fivt.org/tsvetkoveg/project/-/settings/integrations)
